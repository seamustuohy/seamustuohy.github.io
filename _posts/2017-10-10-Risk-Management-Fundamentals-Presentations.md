...
An introduction to risk managements core concepts, to the outputs and outcomes of the sessions, and how risk assessment can fit into an advocacy communities overarching work. This intro is primarily aimed at: - Building a shared language that will allow participants to communicate back their learnings and findings from the sessions to the larger community; and
